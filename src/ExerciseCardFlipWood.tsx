...
import './ExerciseCardFlipWood.css';

interface ExerciseCardFlipWoodProps {
  title: string;
  subtitle: string;
  exercises: string[];
  ...
  className?: string;
  showFlipIndicator?: boolean; // Mostrar indicador de flip
}

const ExerciseCardFlipWood: React.FC<ExerciseCardFlipWoodProps> = ({
  title,
  subtitle,
  exercises,
  backSubtitle,
  ...
  return (
    <div 
      ref={containerRef}
      className={`flip-card-wood ${className} ${isFlipped ? 'flipped' : ''}`}
    ...
    >
      ...
      >
        ...
        <div className="flip-card-front">
          ...
          {title && <div className="exercise-card-divider"></div>}
          ...
          {/* Indicador de flip */}
          {hasBackContent && showFlipIndicator && (
...
export default ExerciseCardFlipWood;
